        ...
        <div className="flex min-h-screen items-center justify-center bg-background p-4 flex-col">
            ...
            <Card className="w-full max-w-md border-border glassmorphism shadow-2xl">
                <CardHeader className="space-y-1 text-center">
                    ...
                    <CardDescription>
                        Join to start managing your APIs securely
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    ...
                    <Button variant="outline" type="button" onClick={handleGoogleSignup} className="w-full border-border bg-transparent hover:bg-white/5" disabled={loading}>
